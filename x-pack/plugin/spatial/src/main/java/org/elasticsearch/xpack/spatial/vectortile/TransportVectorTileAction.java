...
public class TransportVectorTileAction
    ...
    protected VectorTileAction.Response newResponse(VectorTileAction.Request request,
        ...
        List<byte[]> vectorTiles = new ArrayList<>();
