...
final class CoordIJK {
    ...
    public void upAp7r() {
        ...
        int i = (int) Math.round((Math.addExact(Math.multiplyExact(2, this.i), this.j)) / 7.0);
        int j = (int) Math.round((Math.subtractExact(Math.multiplyExact(3, this.j), this.i)) / 7.0);
        this.i = i;
        this.j = j;
        this.k = 0;
        ijkNormalize();
    ...
    public void upAp7() {
        i = Math.subtractExact(this.i, this.k);
        j = Math.subtractExact(this.j, this.k);
        int i = (int) Math.round((Math.subtractExact(Math.multiplyExact(3, this.i), this.j)) / 7.0);
        int j = (int) Math.round((Math.addExact(Math.multiplyExact(2, this.j), this.i)) / 7.0);
        this.i = i;
        this.j = j;
        this.k = 0;
        ijkNormalize();
